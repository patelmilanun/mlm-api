...
router
  ...
  .get(auth('getVideos'), validate(videoValidation.getVideos), videoController.getVideos);

router
  .route('/:videoId')
  .get(auth('getVideos'), validate(videoValidation.getVideo), videoController.getVideo)
